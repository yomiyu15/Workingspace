...
interface Booking {
  ...
  created_at: string;
  notes?: string;
  last_edited_by?: string; // <-- new field
}
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      const normalized = rows.map((row: any) => ({
        ...
        last_edited_by: row.last_edited_by || null, // <-- ensure it's included
      }));
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="font-medium">
                          {selectedBooking.workspace?.name || "N/A"}
                        </p>
                        <p className="text-sm text-gray-500">
                          {selectedBooking.workspace?.locationName}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Duration</p>
                        <p className="font-medium">
                          {selectedBooking.duration_unit?.toUpperCase() ||
                            "DAY"}
                        </p>
                      </div>
                      <div>
                      ...
                      <div className="space-y-2">
                        ...
                        {selectedBooking.tax_amount && (
                          <div className="flex justify-between">
                            ...
                            <span>
                              {formatCurrency(selectedBooking.tax_amount)}
                            </span>
                          </div>
                        )}
